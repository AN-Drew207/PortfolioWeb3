...
export const ItemTech: React.FC<any> = ({
	...
	return (
		<div
			className={clsx(
				className,
				'md:w-48 h-auto rounded-xl flex items-center justify-center relative border border-primary overflow-hidden px-2 py-2'
			)}
		>
			<img
				src={img}
				className={clsx(classNameImage, 'md:h-8 max-w-10')}
				alt=""
			/>
